...
final AutoDisposeFutureProviderFamily<List<LeaveRequest>, String?>
    ...
    FutureProvider.autoDispose.family<List<LeaveRequest>, String?>(
  (ref, status) => ref.watch(hrServiceProvider).leaveRequests(status: status),
);
...
final AutoDisposeFutureProviderFamily<LeaveBalancesPage, int>
    ...
    FutureProvider.autoDispose.family<LeaveBalancesPage, int>(
...
final AutoDisposeFutureProviderFamily<List<LoanPayment>, String>
    ...
    FutureProvider.autoDispose.family<List<LoanPayment>, String>(
