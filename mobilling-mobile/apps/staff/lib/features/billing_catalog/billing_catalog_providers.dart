...
final AutoDisposeFutureProviderFamily<StaffDocument, String>
    staffDocumentProvider =
    FutureProvider.autoDispose.family<StaffDocument, String>(
...
final AutoDisposeFutureProviderFamily<List<StaffProductAddon>, String?>
    addonsProvider =
    FutureProvider.autoDispose.family<List<StaffProductAddon>, String?>(
  (ref, search) =>
...
final AutoDisposeFutureProviderFamily<List<StaffConfigGroup>, String?>
    configGroupsProvider =
    FutureProvider.autoDispose.family<List<StaffConfigGroup>, String?>(
  (ref, search) =>
...
final AutoDisposeFutureProviderFamily<List<StaffCoupon>, String?>
    couponsProvider =
    FutureProvider.autoDispose.family<List<StaffCoupon>, String?>(
  (ref, search) =>
