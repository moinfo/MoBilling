  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      child: InkWell(
        ...
        onTap: () => context.push(Routes.ticketPath(ticket.id)),
        child: Padding(
          padding: const EdgeInsets.all(Spacing.md),
          child: Column(
...
class _KnowledgebaseListState extends ConsumerState<_KnowledgebaseList> {
  ...
  @override
  Widget build(BuildContext context) {
    final kb = ref.watch(knowledgebaseProvider(_search.isEmpty ? null : _search));
          ...
          child: kb.when(
            ...
            error: (error, _) => StateMessage(
              ...
              onAction: () => ref.invalidate(
                  knowledgebaseProvider(_search.isEmpty ? null : _search)),
            ),
                            ...
                            children: [
                              for (final (i, article)
                                ...
                                ListTile(
                                  ...
                                  onTap: () => context
                                      .push(Routes.kbPath(article.slug)),
                                ),
                              ],
                            ],
                          ),
