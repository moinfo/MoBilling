...
Schedule::command('whatsapp:cleanup-sessions')->dailyAt('04:15')->withoutOverlapping();
Schedule::command('whatsapp:expire-abandoned-orders')->dailyAt('10:30')->withoutOverlapping();
