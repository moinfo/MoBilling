...
Route::middleware(['auth:sanctum', 'idle.timeout', 'tenant'])->group(function () {
    ...
    Route::middleware('permission:products.read')->get('/product-addons', [\App\Http\Controllers\ProductAddonController::class, 'index']);
    Route::middleware('permission:products.create')->post('/product-addons', [\App\Http\Controllers\ProductAddonController::class, 'store']);
    ...
    Route::prefix('reports')->group(function () {
        ...
        Route::middleware('permission:reports.balance_statement')->get('/bank-balance-statement/pdf', [ReportController::class, 'bankBalanceStatementPdf']);
    ...
    Route::middleware('permission:hosting.settings')->group(function () {
        ...
        Route::post('/servers/{server}/packages', [\App\Http\Controllers\ServerController::class, 'storePackage']);
        Route::put('/servers/{server}/packages/{package}', [\App\Http\Controllers\ServerController::class, 'updatePackage']);
        Route::delete('/servers/{server}/packages/{package}', [\App\Http\Controllers\ServerController::class, 'destroyPackage']);
    });
    ...
    Route::middleware('permission:hosting.suspend')->post('/hosting-accounts/{hostingAccount}/clear-bandwidth-suspension', [\App\Http\Controllers\HostingServiceController::class, 'clearBandwidthSuspension']);
    ...
    Route::middleware('permission:linode.manage')->prefix('linode')->group(function () {
        ...
        Route::get('/accounts/{account}/invoices/{invoice}/download', [\App\Http\Controllers\LinodeController::class, 'downloadInvoice']);
...
Route::middleware(['auth:sanctum', 'idle.timeout', 'client_portal'])->prefix('portal')->group(function () {
    ...
    Route::post('/linode/servers/{server}/domains/{domainResource}/point-to-server', [\App\Http\Controllers\Portal\PortalLinodeController::class, 'dnsPointToServer'])->middleware('throttle:10,1');
