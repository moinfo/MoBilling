...
/**
 * "Place Orders" permission — lets staff place product/domain orders on behalf
 * of a client (WHMCS-style "Add New Order"). Granted to every tenant's
 * allowlist and to admin roles by default.
 */
return new class extends Migration
{
    public function up(): void
    {
        $perm = Permission::firstOrCreate(
            ['name' => 'orders.create'],
            ['label' => 'Place Orders', 'category' => 'crud', 'group_name' => 'Billing'],
        );
    ...
    {
        Permission::where('name', 'orders.create')->delete();
    }
};
