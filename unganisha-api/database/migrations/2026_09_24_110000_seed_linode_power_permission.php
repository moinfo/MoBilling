...
/** Linode server power actions — all three layers (see three-layer permission system). Roles: admin only. */
return new class extends Migration
{
    private array $perms = [
        ['name' => 'linode.power', 'label' => 'Reboot / shut down / boot Linode servers', 'category' => 'crud', 'group_name' => 'Linode'],
    ];
