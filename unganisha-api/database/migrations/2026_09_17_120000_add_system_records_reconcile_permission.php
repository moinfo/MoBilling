...
/** Separate permission for confirming/un-confirming SMS+statement reconciliation — see SystemRecordController::toggleSmsConfirmation()/toggleStatementConfirmation(). */
return new class extends Migration
{
    public function up(): void
    {
        $perm = ['name' => 'system_records.reconcile', 'label' => 'Confirm/un-confirm system record reconciliation', 'category' => 'crud', 'group_name' => 'System Records'];
    ...
    {
        $id = DB::table('permissions')->where('name', 'system_records.reconcile')->value('id');
        if ($id) {
